...
namespace File.Api.PerformanceTests {
    ...
    public class UploadStreamLoadTestBenchmarks {
        ...
        [Benchmark]
        public void UploadStreamLoad() => Parallel.For(0, LOAD_LIMIT, (i, s) =>  Client.PostAsync("api/stream", MultipartContent[i]).Wait());
    }
}
