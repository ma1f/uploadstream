...
namespace File.Api.PerformanceTests {
    ...
    public class UploadStreamModelBenchmarks {
        ...
        [Benchmark]
        public async Task UploadStreamNoModel() => await Client.PostAsync("api/stream/modeless", MultipartContent).Result.Content.ReadAsStringAsync();
        [Benchmark]
        public async Task UploadStreamNoModelWithBinding() => await Client.PostAsync("api/stream/binding", MultipartContent).Result.Content.ReadAsStringAsync();
        [Benchmark]
        public async Task UploadStreamModelWithBinding() => await Client.PostAsync("api/stream/binding/model", MultipartContent).Result.Content.ReadAsStringAsync();
    }
}
